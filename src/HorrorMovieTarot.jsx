...
const HorrorMovieTarot = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 via-red-900 to-black p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-xl text-white animate-pulse">Loading the mystical cards...</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 via-red-900 to-black p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-xl text-white">Failed to load the cursed deck...</div>
          <div className="text-sm text-white mt-2">{loadError}</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen p-6 overflow-hidden relative white-text">
      {/* Liquid Ether Background */}
      <div className="fixed inset-0 z-0">
        <LiquidEther
          colors={['#1a0000', '#8B0000', '#000000']}
          mouseForce={20}
          cursorSize={100}
          isViscous={false}
          viscous={30}
      ...
      {particles.map(particle => (
        <div
          key={particle.id}
          className="fixed pointer-events-none text-white animate-pulse"
          style={{
            left: particle.x,
            top: particle.y,
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div className="text-center mb-8 md:mb-12 relative px-4">
          ...
          <div className="flex justify-center items-center gap-3 md:gap-4 mb-4">
            ...
            <Moon className="w-5 h-5 md:w-6 md:h-6 text-white animate-spin" style={{animationDuration: '3s'}} />
        ...
        <div className="flex justify-center mb-8">
          <button
            onClick={toggleAudio}
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-800 to-gray-900 border border-purple-500 rounded-lg text-white hover:text-purple-200 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-purple-500/25"
          >
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 md:gap-4 mb-8 md:mb-12 px-4">
          <button
            ...
            className={`
              ...
              ${isShuffling 
                ? 'bg-gradient-to-r from-purple-900 to-red-900 text-white cursor-not-allowed' 
          ...
          <div className="flex justify-center mb-12">
            <div className="relative">
              ...
              {[...Array(Math.min(7, allCards.length - deckPosition))].map((_, i) => (
                ...
                >
                  <div className="text-center">
                    <div className="text-4xl mb-3 text-white animate-pulse">⦿</div>
                    ...
                    <div className="text-xs font-mono text-white mt-2">◊ ⟢ ✦ ⟢ ◊</div>
                  </div>
                </div>
              ))}
              
              {allCards.length - deckPosition === 0 && (
                <div className="w-40 h-60 border-4 border-dashed border-purple-500 rounded-2xl flex items-center justify-center text-white bg-gradient-to-br from-gray-900/50 to-purple-900/20">
                  <div className="text-center">
            ...
            `}>
              ...
              <div className="text-center mb-6 md:mb-8 relative">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 mb-4 md:mb-6">
                  ...
                  <div className="text-2xl md:text-4xl text-white animate-spin" style={{animationDuration: '3s'}}>⦿</div>
                  
                  <div className="flex items-center gap-2 text-white text-lg md:text-xl">
              ...
              <div className="relative px-4 md:px-8">
                <div className="absolute -left-2 md:-left-4 top-0 text-4xl md:text-6xl text-white/30 font-serif">"</div>
                <div className="absolute -right-2 md:-right-4 bottom-0 text-4xl md:text-6xl text-white/30 font-serif">"</div>
                <p className={`
              ...
              <div className="text-center mt-6 md:mt-8">
                <div className="flex justify-center items-center gap-2 text-white text-base md:text-lg">
